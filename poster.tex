...
\headerbox{Main Goals}{name=subtopic1,column=0,below=introduction,span=1}{
  ...
  \vspace{0.1em}\\
  - Cos4Cloud: EU Citizen observatories services
  \vspace{0.1em}\\
  ...
  \vspace{0.08cm} %remove this, only added for spacing

  {
    \hspace{1.3cm}
    \centering
    \includegraphics[scale=.38]{images/goals_logos.jpg}
  }
...
\headerbox{OpenSource and OpenHardware project}{name=subtopic3,column=1,below=introduction,span=2}{
  ...
  \vspace{0.001cm} %remove this, only added for spacing
}
  ...
  {
    {
      \hspace{0.3cm}
      \centering
      \includegraphics[scale=.59]{images/trebola-logo-01.jpg}
    }
    {
      \hspace{-0.3cm}
      \centering
      \includegraphics[scale=.11]{images/cos4Cloud_logo-02.png}
    }
    {
      \hspace{-0.1cm}
      \centering
      \includegraphics[scale=.143]{images/https_canairio.png}
    }
  }
