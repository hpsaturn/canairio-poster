...
{\includegraphics[width=.13\linewidth]{images/logo.png}} % CanAir.io logo
...
\headerbox{CanAirIO Citizen Network for Air Quality Monitoring}{name=introduction,column=0,row=0, span=3}{
  This is an Open Source initiative that uses for now a ESP32 module and some kind PM2.5
  sensors, interfaced with an Android client app to have static (WiFi) or mobile
...
\headerbox{FOSSi and CanAir.io}{name=subtopic2,column=0,below=subtopic1,span=1}{
...
% inserts an image inside the box, 5 rows high
{
  \hspace{0.2cm}
  \centering
  \includegraphics[width=.96\linewidth]{images/collage_horizontal.jpg} 
}
\vspace{0.05cm} %remove this, only added for spacing
}


\headerbox{Output}{name=topicoverview,column=0,span=3,below=subtopic2}{
{
    {
        \hspace{0.1cm}
        \centering
    	\includegraphics[scale=.30]{images/mobile_track.png}
    }
    {
        \hspace{1.5cm}
        \centering
...
\headerbox{Sponsors and Contact}{name=conclusion,column=0,below=topicoverview,span=3,above=bottom}{
Final conclusions
